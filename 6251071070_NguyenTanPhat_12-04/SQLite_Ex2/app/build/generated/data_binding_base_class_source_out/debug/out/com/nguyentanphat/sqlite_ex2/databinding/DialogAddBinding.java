...
public final class DialogAddBinding implements ViewBinding {
  ...
  private DialogAddBinding(@NonNull LinearLayout rootView, @NonNull Button btnCancel,
  ...
  public static DialogAddBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogAddBinding((LinearLayout) rootView, btnCancel, btnSave, edtName, edtPrice);
    }
