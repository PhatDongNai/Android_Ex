...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull LinearLayout rootView, @NonNull Button btnCancel,
      @NonNull Button btnCapture, @NonNull Button btnSave, @NonNull EditText edtDesCription,
      @NonNull EditText edtName, @NonNull ImageView imvPhoto) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((LinearLayout) rootView, btnCancel, btnCapture, btnSave,
          edtDesCription, edtName, imvPhoto);
    }
