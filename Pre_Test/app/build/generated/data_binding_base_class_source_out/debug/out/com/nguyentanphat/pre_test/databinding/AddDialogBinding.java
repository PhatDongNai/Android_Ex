...
public final class AddDialogBinding implements ViewBinding {
  ...
  private AddDialogBinding(@NonNull LinearLayout rootView, @NonNull Button btnCancel,
  ...
  public static AddDialogBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new AddDialogBinding((LinearLayout) rootView, btnCancel, btnCapture, btnSave,
