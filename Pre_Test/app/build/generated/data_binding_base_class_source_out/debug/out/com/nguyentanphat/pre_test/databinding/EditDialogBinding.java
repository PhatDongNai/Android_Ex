...
public final class EditDialogBinding implements ViewBinding {
  ...
  private EditDialogBinding(@NonNull LinearLayout rootView, @NonNull Button btnCancel,
  ...
  public static EditDialogBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new EditDialogBinding((LinearLayout) rootView, btnCancel, btnSave, edtName, edtPrice);
    }
