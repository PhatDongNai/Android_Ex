...
public final class ItemListBinding implements ViewBinding {
  ...
  private ItemListBinding(@NonNull LinearLayout rootView, @NonNull ImageView btnDelete,
      @NonNull ImageView btnEdit, @NonNull ImageView imvPhoto, @NonNull TextView txtCategory,
      @NonNull TextView txtDes, @NonNull TextView txtName, @NonNull TextView txtPrice) {
  ...
  public static ItemListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemListBinding((LinearLayout) rootView, btnDelete, btnEdit, imvPhoto, txtCategory,
          txtDes, txtName, txtPrice);
    }
