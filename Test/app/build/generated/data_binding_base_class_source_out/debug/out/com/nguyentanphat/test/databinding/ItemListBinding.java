...
public final class ItemListBinding implements ViewBinding {
  ...
  private ItemListBinding(@NonNull LinearLayout rootView, @NonNull ImageView imvPhoto,
      @NonNull TextView txtCategory, @NonNull TextView txtDes, @NonNull TextView txtName,
  ...
  public static ItemListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemListBinding((LinearLayout) rootView, imvPhoto, txtCategory, txtDes, txtName,
          txtPrice);
    }
